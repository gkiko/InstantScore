...
public class PoolingByteArrayOutputStream extends ByteArrayOutputStream {
    /**
     * If the {@link #PoolingByteArrayOutputStream(com.kuku.instantscore.volley.toolbox.ByteArrayPool)} constructor is called, this is
     * the default size to which the underlying byte array is initialized.
     */
    private static final int DEFAULT_SIZE = 256;

    private final com.kuku.instantscore.volley.toolbox.ByteArrayPool mPool;
     ...
     */
    public PoolingByteArrayOutputStream(com.kuku.instantscore.volley.toolbox.ByteArrayPool pool) {
     ...
     *        minimum size.
     */
    public PoolingByteArrayOutputStream(com.kuku.instantscore.volley.toolbox.ByteArrayPool pool, int size) {
        mPool = pool;
